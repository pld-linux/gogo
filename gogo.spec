...
%description -l pl
GOGO jest programem do kompresji plików MP3, który zosta³ stworzony
na podstawie programu lame. Program ten potrafi byæ dwa razy szybszy
od orygina³u w systemie z procesorem K6-2 315MHz, zachowuj±c jednocze¶nie
jako¶æ kompresowanych plików. GOGO wykorzystuje MMX, instrukcje 3D Now!
oraz SSE.
